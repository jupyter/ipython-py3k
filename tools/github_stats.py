...
if __name__ == "__main__":
    ...
    pulls = list(filter(is_pull_request, issues))
    regular = [i for i in issues if not is_pull_request(i)]
    n_issues, n_pulls, n_regular = list(map(len, (issues, pulls, regular)))
