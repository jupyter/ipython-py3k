...
class Kernel(HasTraits):
    ...
    def execute_request(self, ident, parent):
        try:
            ...
            return
        pyin_msg = self.session.send(self.iopub_socket, 'pyin',{'code':code}, parent=parent)
        ...
        try:
            ...
            exc_msg = self.session.send(self.iopub_socket, 'pyerr', exc_content, parent)
        ...
        # Send the reply.
        reply_msg = self.session.send(self.shell_socket, 'execute_reply', reply_content, parent, ident=ident)
    ...
    def _raw_input(self, prompt, ident, parent):
        ...
        msg = self.session.send(self.stdin_socket, 'input_request', content, parent)
