...
class IPEngineAppConfigLoader(ClusterDirConfigLoader):
    ...
    def _add_arguments(self):
        ...
        paa('-s',
            type=str, dest='Global.extra_exec_file',
...
class IPEngineApp(ApplicationWithClusterDir):
    ...
    def create_default_config(self):
        ...
        self.default_config.Global.extra_exec_file = ''
        ...
        self.default_config.Global.url_file = ''
        self.default_config.Global.url_file_name = 'ipcontroller-engine.json'
